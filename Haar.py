...
def _normalized_decomposition(coefficient):
    # Haar decomposition of array inplace
    return
def _normalized_decomposition_step(coefficient):
    # One step of Haar decomposition of array inplace
    return
def _normalized_reconstruction(coefficient):
    # Haar reconstruction of array inplace
    return
def _normalized_reconstruction_step(coefficient):
